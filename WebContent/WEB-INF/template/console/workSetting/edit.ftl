...
<title>${message("console.dictSchool.add")} -图书智能管理推荐系统</title>
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
             	...
             	<form id="inputForm" action="update.ct" method="post">
					<input type="hidden" name="id" value="${workSetting.id}">
					<input type="hidden" name="isDefalut" value='${workSetting.isDefalut?string}' />
	             	<div class="row">
	                    <div class="col-lg-12">
	                                ...
	                                <div class="table-responsive">
	                                     <table id="listTable" class="table table-striped">
											<tr>
												...
												<td>
													<input type="text" name="name" value="${workSetting.name}" class="form-control" maxlength="20" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<div class="input-group">
														<input type="text" id="workTime" name="workTime" value="${workSetting.workTime}"/>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<div class="input-group">
														<input type="text" id="startWorkTime" name="startWorkTime" value="${workSetting.startWorkTime}"/>
														—
														<input type="text" id="endWorkTime" name="endWorkTime" value="${workSetting.endWorkTime}"/>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<input type="text" id="closingTime" name="closingTime" value="${workSetting.closingTime}" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<div class="input-group">
														<input type="text" id="startClosingTime" name="startClosingTime" value="${workSetting.startClosingTime}" />
														—
														<input type="text" id="endClosingTime" name="endClosingTime" value="${workSetting.endClosingTime}" />
													</div>
												</td>
											</tr>
