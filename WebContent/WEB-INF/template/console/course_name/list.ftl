...
<title>${message("console.courseName.list")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>${message("console.courseName.list")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                           <strong>${message("console.courseName.list")} <span>(${message("console.page.total", page.total)})</span></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-4 m-b-xs">
                                    	<div class="btn-group">
	                                       	[@shiro.hasPermission name = "console:addCourseName"]
	                                        <a href="add.ct" class="btn btn-primary">
												<span class="addIcon">&nbsp;</span>${message("console.common.add")}
											</a>
										   	[/@shiro.hasPermission]
	                                        [@shiro.hasPermission name = "console:deleteCourseName"]
                                     ...
                                     <div class="table-responsive">
	                                     <table id="listTable" class="table table-striped">
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="dictSchool">${message("CourseName.dictSchool")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="name">${message("CourseName.name")}</a>
													</th>
													<th>
												...
												[#list page.content as courseName]
													<tr>
														<td>
															<input type="checkbox" name="ids" value="${courseName.id}" />
														</td>
														<td>
															${courseName.dictSchool.name}
														</td>
														<td>
															${courseName.name}
														</td>
														<td>
															<span title="${courseName.createDate?string("yyyy-MM-dd HH:mm:ss")}">${courseName.createDate}</span>
														</td>
														<td>
														[@shiro.hasPermission name = "console:editCourseName"]
															<a href="edit.ct?id=${courseName.id}">[${message("console.common.edit")}]</a>
														[/@shiro.hasPermission]
														</td>
													</tr>
												[/#list]
