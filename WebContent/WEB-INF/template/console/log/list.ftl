...
<title>${message("console.log.list")} - 小书僮™智慧幼教管理平台</title>
...
$().ready(function() {
	...
	$clearButton.click(function() {
		...
		$.dialog({
			type: "warn",
			content: "${message("console.dialog.clearConfirm")}",
			onOk: function() {
				$.ajax({
					url: "clear.ct",
					type: "POST",
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>${message("console.log.list")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("console.log.list")} <span>(${message("console.page.total", page.total)})</span></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	                                    ...
	                                    <div class="col-sm-4 m-b-xs">
											<div class="btn-group">
											    <div class="btn-group">
													...
													[/@shiro.hasPermission]
													[@shiro.hasPermission name = "console:log_button_clearButton"]
														<a href="javascript:;" id="clearButton" class="btn btn-primary">
															<span class="clearIcon">&nbsp;</span>${message("console.common.clear")}
														</a>
													[/@shiro.hasPermission]
	                                     ...
	                                     <table id="listTable" class="table table-striped">
											...
											[#list page.content as log]
												<tr>
													...
													<td>
														<a href="view.ct?id=${log.id}">[${message("console.common.view")}]</a>
													</td>
												</tr>
											[/#list]
										</table>
