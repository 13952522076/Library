...
<title>${message("新增广告分类")} - 小书僮™智慧幼教管理平台</title>
	...
	$inputForm.validate({
		rules: {
		    name:{
		    	...
		    	maxlength:10,
		    	remote: {
					url: "check_name.ct?preName=${addCategory.name}",
					cache: false
				}
		    },
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("新增广告分类")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("新增广告分类")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	                                    ...
	                                    <table class="table table-striped">
											<tr>
										 	...
										 	<tr>
									 			...
									 			<td>
									 				<input type="radio" value="true" name="status" checked id="statusTrue"><label for="statusTrue">启用</label>
									 				<input type="radio" value="false" name="status" id="statusFalse"><label for="statusFalse">禁用</label>
									 			</td>
										 	</tr>
										</table>
										<table class="input">
