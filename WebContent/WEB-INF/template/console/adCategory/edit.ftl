...
<title>${message("编辑广告分类")} - 小书僮™智慧幼教管理平台</title>
	...
	$inputForm.validate({
		rules: {
		    name:{
		    	...
		    	maxlength:10,
		    	remote: {
					url: "check_name.ct?preName=${adCategory.name}",
					cache: false
				}
		    },
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("编辑广告分类")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("编辑广告分类")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
	             ...
	             <form id="inputForm" action="update.ct" method="post">
	             	<input type="hidden" name="id" value="${adCategory.id}">
		             <div class="row">
	                    <div class="col-lg-12">
	                            ...
	                            <div class="ibox-content" style="margin:0 auto;">
	                                ...
	                                <div class="table-responsive">
	                                    <table class="table table-striped">
											<tr>
												<th>
													<span class="requiredField">*</span>${message("分类名")}:
												</th>
												<td>
													<input name="name" class="form-control" style="width:50%;" value="${adCategory.name}">
												</td>
											</tr>
										 	<tr>
										 		<th>
									 			...
									 			<td>
									 				<input type="radio" value="true" name="status" [#if adCategory.status == true]checked[/#if] id="statusTrue"><label for="statusTrue">启用</label>
									 				<input type="radio" value="false" name="status" [#if adCategory.status == false]checked[/#if] id="statusFalse"><label for="statusFalse">禁用</label>
									 			</td>
										 	</tr>
										</table>
										<table class="input">
