...
<title>${message("console.news.list")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>${message("console.news.list")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                           <strong>${message("console.news.list")} <span>(${message("console.page.total", page.total)})</span></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                                    ...
                                    <div class="col-sm-6 m-b-xs">
                                    	<div class="btn-group">
											...
											<div class="btn-group">
	                                       	...
	                                       	[@shiro.hasPermission name = "console:newsCategoryMng"]
	                                        <a href="${base}/console/news_category/list.ct" class="btn btn-primary">
												<span class="addIcon">&nbsp;</span>${message("console.news.newsCategoryMng")}
											</a>
											[/@shiro.hasPermission]
										</div>
                                    </div>
													...
													<tr>
														...
														<td>
															<div style=";white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-item">
																<div class="imgBox">	
																	<img src="${news.smallIconfile}" />
																</div>
																<div class="contBox">	
																	<p class="cont-tit">${news.title}<span>【${news.newsCategory.categoryName}】</span></p>	
																	<p class="cont-detail mt10">
																		[#if news.summary?length lt 150]
																			${news.summary}
																		[#else]
																			内容过长,点击编辑查看内容...
																		[/#if]
																...
																<div class="optionBox fr">	
																	<a class="btn_list_option editNews_btn" href="/news/editNews?id=3556483"><span>编辑</span></a>	
																	<a class="btn_list_option sheildingNews_btn" href="javascript:;" onclick="News.indexPage.shielding('3556483',0)" id="pb3556483">
																	<span>屏蔽</span></a>
																</div>
																-->
															</div>
														...
														<td>
														[@shiro.hasPermission name = "console:editNews"]
															<a href="edit.ct?id=${news.id}">[${message("console.common.edit")}]</a>
														[/@shiro.hasPermission]
														</td>
													</tr>
												[/#list]
