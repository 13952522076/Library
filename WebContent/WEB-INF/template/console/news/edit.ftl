...
<title>${message("console.news.edit")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("console.news.edit")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("console.news.edit")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	                                     ...
	                                     <table class="table table-striped">
													...
													<select name="newsCategoryId" class="form-control m-b">
														<option value="">${message("console.common.select")}</option>
														 [#list newsCategories as newsCategory]
															<option value="${newsCategory.id}" [#if newsCategory == news.newsCategory] selected="selected" [/#if]>
												...
												<td>
													<div class="itemList-upload">
														<div class="imgShowBox">
														    [#if news.smallIconfile??]
														        <img src="${news.smallIconfile}" alt="上传新闻预览图" id="smallIconfilePreview" class="newsPreview" />
														    [#else]
														        <img src="${base}/resources/console/images/newsUpload.png" alt="上传新闻预览图" id="smallIconfilePreview" class="newsPreview" />
														    [/#if]
															<a href="javascript:;" title="删除图片" [#if news.smallIconfile??] style="display:inline-block"[/#if] class="delImg" id="delSmallIconfileImg">×</a>
														</div>
														<div class="uploadContainer" style="margin-left: 7px;">
															<input type="file" id="smallIconfileImageUpload" />
															<input type="hidden" id="smallIconfile" name="smallIconfile" value="${news.smallIconfile}">
														</div>
													</div>
												</td>
											</tr>
											...
											<tr>
												...
												<td style="text-align: left;">
													<textarea name="content" id="editor" class="form-control">${news.content?html}</textarea>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="author"  class="form-control" maxlength="50" value="${news.author}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td style="text-align: left;">
													<input type="text" name="source"  class="form-control" maxlength="50" value="${news.source}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="detailUrl" class="form-control" maxlength="255" value="${news.detailUrl}"/>
												</td>
											</tr>
										</table>
										<table class="input">
