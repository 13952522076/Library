...
<title>${message("console.qualityCourse.list")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>${message("console.qualityCourse.list")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                           <strong>${message("console.qualityCourse.list")} <span>(${message("console.page.total", page.total)})</span></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                    	...
                    	<div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <div class="row">
                                    ...
                                    <div class="btn-group">
	                                       	[@shiro.hasPermission name = "console:addQualityCourse"]
	                                        <a href="add.ct" class="btn btn-primary">
												<span class="addIcon">&nbsp;</span>${message("console.common.add")}
											</a>
										   	[/@shiro.hasPermission]
	                                        [@shiro.hasPermission name = "console:deleteQualityCourse"]
                                ...
                                <div class="table-responsive">
                                     <div class="table-responsive">
	                                     <table id="listTable" class="table table-striped">
												...
												[#list page.content as qualityCourse]
													<tr>
														<td>
															<input type="checkbox" name="ids" value="${qualityCourse.id}" />
														</td>
														<td>
															<div style=";white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-item">
																<div class="contBox">	
																<p class="cont-tit">${qualityCourse.description}<span>【${qualityCourse.createDate}】</span></p>	
																<p class="cont-detail mt10">
																[#if qualityCourse.status = 0]
																正常
																[#else]
																屏蔽
																[/#if]
														...
														<td>
														[@shiro.hasPermission name = "console:editQualityCourse"]
															<a href="edit.ct?id=${qualityCourse.id}">[${message("console.common.edit")}]</a>
														[/@shiro.hasPermission]
														</td>
													</tr>
												[/#list]
