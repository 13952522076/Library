...
<title>${message("console.announcement.list")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>${message("console.announcement.list")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                           <strong>${message("console.announcement.list")} <span>(${message("console.page.total", page.total)})</span></strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-6 m-b-xs">
                                 		<div class="btn-group">
	                                       	[@shiro.hasPermission name = "console:addAnnouncement"]
	                                        <a href="add.ct" class="btn btn-primary">
												<span class="addIcon">&nbsp;</span>${message("console.common.add")}
											</a>
										   	[/@shiro.hasPermission]
	                                        [@shiro.hasPermission name = "console:deleteAnnouncement"]
													...
													<tr>
														...
														<td>
															<div style=";white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-item">
																<div class="imgBox">	
																	<img src="${announcement.smallIconfile}" />
																</div>
																<div class="contBox">	
																<p class="cont-tit">${announcement.title}<span>【${announcement.timePublish?string("yyyy-MM-dd")}】</span></p>	
																<p class="cont-detail mt10">${announcement.summary}</p></div>
															</div>
														</td>
														<td>
														[@shiro.hasPermission name = "console:editAnnouncement"]
															<a href="edit.ct?id=${announcement.id}">[${message("console.common.edit")}]</a>
														[/@shiro.hasPermission]
														</td>
													</tr>
												[/#list]
