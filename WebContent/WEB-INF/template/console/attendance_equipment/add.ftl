...
<title>${message("console.attendanceEquipment.add")} - 小书僮™智慧幼教管理平台</title>
	...
	$inputForm.validate({
		rules: {
			...
			equipmentSequence: {
				...
				maxlength:50,
				remote: {
					url: "check_equipmentSequence.ct",
					cache: false
				}
			},
			equipmentName: {
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("console.attendanceEquipment.add")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("console.attendanceEquipment.add")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	                                ...
	                                <div class="table-responsive">
	                                     <table id="listTable" class="table table-striped">
	                                        <tr>
												...
												<td>
													<input type="text" name="equipmentSequence" class="form-control" maxlength="50" />
												</td>
											</tr>
											<tr>
												<th>
											...
											<tr>
												...
												<td>
													<input type="text" name="ipAddress" class="form-control" maxlength="50" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="port" class="form-control" maxlength="20" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="firmwareVersion" class="form-control" maxlength="20" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="remark" class="form-control" maxlength="20" />
												</td>
											</tr>
										</table>
										<table class="input">
