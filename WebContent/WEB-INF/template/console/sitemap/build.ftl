...
<title>${message("console.admin.edit")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("console.sitemap.build")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("console.sitemap.build")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
