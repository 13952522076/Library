...
<title>${message("console.role.add")} - 小书僮™智慧幼教管理平台</title>
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <strong>${message("console.appRole.edit")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	                                ...
	                                <div class="table-responsive">
	                                     <table  class="table table-bordered">
											<tr>
												...
												<td colspan="2">
													<input type="text" name="name" value="${role.name}" class="form-control" maxlength="200" />
												</td>
											</tr>
											<tr>
												<th>
											...
											<tr>
												...
												<td>
													<ul class="authorities" style="padding-left:0px">
														<li>
															<input type="checkbox"  name="memberTypes" id="teacherIcon" value="teacher" [#if role.memberTypes?seq_contains("teacher")] checked="checked"[/#if]/>
														 	<label for="teacherIcon">${message("console.appRole.teacher")}</label>
														 </li>
														 <li>
															<input type="checkbox"  name="memberTypes" id="parentsIcon" value="patriarch" [#if role.memberTypes?seq_contains("patriarch")] checked="checked"[/#if]/>
