...
<title>${message("console.poster.list")} - 小书僮™智慧幼教管理平台</title>
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-6 m-b-xs">
                                    	<div class="btn-group">
	                                       	[@shiro.hasPermission name = "console:addPoster"]
	                                        <a href="add.ct" class="btn btn-primary">
												<span class="addIcon">&nbsp;</span>${message("console.common.add")}
											</a>
										   	[/@shiro.hasPermission]
	                                        [@shiro.hasPermission name = "console:deletePoster"]
													...
													<tr>
														...
														<td>
															<div style=";white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-item">
																<div class="imgBox">	
																	<img src="${poster.posterCover}" />
																</div>
																<div class="contBox">	
																	<p class="cont-tit">${poster.posterTitle}<span>【${poster.viewCount}】</span></p>	
														...
														<td>
														[@shiro.hasPermission name = "console:editPoster"]
															<a href="edit.ct?id=${poster.id}">[${message("console.common.edit")}]</a>
														[/@shiro.hasPermission]
														</td>
													</tr>
												[/#list]
