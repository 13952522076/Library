	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
	             <!-- start 广告定向策略-->
	             <form id="inputForm" action="update2.ct" method="post">
	                            ...
	                            <div class="ibox-content" style="margin:0 auto;">
	                                ...
	                                <div class="table-responsive">
	                                     <table class="table table-striped">
	                                        <tr>
												<th>
													<span class="requiredField">*</span>${message("定向学校")}:
												</th>
												<td>
													<div class="col-sm-12 m-b-xs">
														[#list dictSchools as dictSchool]
															 <div class="col-md-3">
															 	<label>
																	<input type="checkbox" name="dictschoolIds"
																		[#list ad.adDictSchools as adDictSchool] 
																			[#if adDictSchool.id == dictSchool.id]
																				checked
																			[/#if]
																		[/#list]
																	 value="${dictSchool.id}">
											...
											<tr>
												...
												<td>
													<div class="col-sm-8 m-b-xs">
														<input type="text" name="beginDate" value="${ad.beginDate}" id="beginDate" class="laydate-icon form-control layer-date" placeholder="开始时间" />
														-
														<input type="text" name="endDate" value="${ad.endDate}" id="endDate" class="laydate-icon form-control layer-date" placeholder="开始时间" />
													</div>
												</td>
											</tr>
										</table>
