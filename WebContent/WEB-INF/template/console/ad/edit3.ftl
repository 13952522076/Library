...
<title>${message("编辑广告")} - 小书僮™智慧幼教管理平台</title>
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
	             <!-- start 广告定向策略-->
	             <form id="inputForm" action="update3.ct" method="post">
	                                ...
	                                <div class="table-responsive">
	                                     <table class="table table-striped">
	                                        <tr>
												...
												<td>
												 	<div class="col-md-4">
													 	<select data-placeholder="广告形式" id="adPosition" name="adPosition" class="chosen-select form-control" tabindex="4">
															<option [#if ad.adPosition == "start"] selected="selected"[/#if] value="start">启动页</option>
															<option [#if ad.adPosition == "index"] selected="selected"[/#if] value="index">首页海报页</option>
															<option [#if ad.adPosition == "news"]selected="selected" [/#if] value="news">新闻页</option>
															<option [#if ad.adPosition == "gd"] selected="selected"[/#if] value="gd">成长记</option>
														<select>
													</div>
											    </td>
											</tr>
											<tr>
												...
												<td>
													<div class="col-sm-4">
														...
														<img src="${ad.adImage}" style="display: none;" height="150px" id="showColumnCoverImage" />
														...
														<input type="hidden" id="columnCoverImage" name="adImage" class="form-control" value="${ad.adImage}"/>
													</div>
													<div class="col-sm-4">
												...
												<td>
												 	<div class="col-md-4">
													 	<select id="showType" data-placeholder="广告展现方式" name="showType" class="chosen-select form-control" tabindex="4">
															<option [#if ad.showType == "pop"] selected="selected"[/#if] value="pop">弹出</option>
															<option [#if ad.showType == "inside"] selected="selected"[/#if] value="inside">当前界面打开</option>
														<select>
													</div>
												</td>
											</tr>
