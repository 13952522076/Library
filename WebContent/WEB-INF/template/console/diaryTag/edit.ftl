...
<head>
    ...
    <title>${message("编辑成长记标签")} - 小书僮™智慧幼教管理平台</title>
            ...
            $inputForm.validate({
                rules: {
                    name: {
                        ...
                        maxlength: 15,
                        remote: {
							url: "checkNameExsit.ct?preName=${diaryTag.name}",
							cache: false
						}
                    }
                },
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>${message("编辑成长记标签")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("编辑成长记标签")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="wrapper wrapper-content animated fadeIn">
                ...
                <form id="inputForm" action="update.ct" method="post">
                	<input type="hidden" name="id" value="${diaryTag.id}">
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="listTable" class="table table-striped">
                                            <tr>
                                                ...
                                                <td><input type="text" name="name" class="form-control" value="${diaryTag.name}" maxlength="20" /></td>
                                            </tr>
                                        </table>
                                        <table class="input">
                                            <tr>
