...
<title>${message("编辑育儿信息")} - 小书僮™智慧幼教管理平台</title>
...
$().ready(function() {
	...
	$inputForm.validate({
		rules: {
			...
			isTop:{
				remote: {
					url: "checkNumByCategory.ct",
					data:{
			       		parentingCategoryId:function(){
			          		return $("#parentingCategoryId").val();
		          		}
 					},   
					cache: false
				}
		...
		messages: {
			isTop:{
				remote: "当前分类置顶信息数不准超过${setting.parentingCategoryLimit}条"
			}
		}
	});
	...
	$delSmallIconfileImg.on("click", function() {
		...
		$.dialog({
			...
			onOk: function() {
			    $smallIconfilePreview.attr("src","${base}/resources/console/images/parentingUpload.png");
	            $smallIconfile.val("");
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("编辑育儿信息")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("编辑育儿信息")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
	             ...
	             <form id="inputForm" action="update.ct" method="post">
	                 <input type="hidden" name="id" value="${parenting.id}" />
	                 <input type="hidden" name="status" value="${parenting.status}" />
		             <div class="row">
	                    <div class="col-lg-12">
	                                ...
	                                <div class="table-responsive">
	                                     <table class="table table-striped">
	                                        <tr>
												...
												<td>
													<select id="parentingCategoryId" name="parentingCategoryId" class="form-control m-b">
														<option value="">${message("console.common.select")}</option>
														 [#list parentingCategories as parentingCategory]
															<option value="${parentingCategory.id}" [#if parentingCategory == parenting.parentingCategory] selected="selected" [/#if]>
											...
											<tr>
												...
												<td>
													<input type="text" name="title" class="form-control"  value="${parenting.title}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<div class="itemList-upload">
														<div class="imgShowBox">
														    [#if parenting.smallIconfile??]
														        <img src="${parenting.smallIconfile}" alt="上传新闻预览图" id="smallIconfilePreview" class="newsPreview" />
														    [#else]
														        <img src="${base}/resources/console/images/parentingUpload.png" alt="上传育儿预览图" id="smallIconfilePreview" class="newsPreview" />
														    [/#if]
															<a href="javascript:;" title="删除图片" [#if parenting.smallIconfile??] style="display:inline-block"[/#if] class="delImg" id="delSmallIconfileImg">×</a>
														</div>
														<div class="uploadContainer" style="margin-left: 7px;">
															<input type="file" id="smallIconfileImageUpload" />
															<input type="hidden" id="smallIconfile" name="smallIconfile" value="${parenting.smallIconfile}">
														</div>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<textarea name="summary" class="form-control">${parenting.summary}</textarea>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td style="text-align: left;">
													<textarea name="content" id="editor" class="form-control">${parenting.content?html}</textarea>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="checkbox" name="isTop" value="true" [#if parenting.isTop==true]checked="checked"[/#if]/>
											...
											<tr>
												...
												<td>
													<input type="text" name="author"  class="form-control" maxlength="50" value="${parenting.author}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td style="text-align: left;">
													<input type="text" name="source"  class="form-control" maxlength="50" value="${parenting.source}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="detailUrl" class="form-control" maxlength="255" value="${parenting.detailUrl}"/>
												</td>
											</tr>
										</table>
										<table class="input">
