...
<title>${message("console.friendLink.edit")} - 小书僮™智慧幼教管理平台</title>
...
<body>
	<div class="path">
		<a href="${base}/console/common/index.ct">${message("console.path.index")}</a> &raquo; ${message("console.friendLink.edit")}
	</div>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						...
						<input type="button" id="browserButton" class="button" value="${message("console.browser.select")}"[#if friendLink.type == "text"] disabled="disabled"[/#if] />
