...
<title>${message("console.member.edit")} - 小书僮™智慧幼教管理平台</title>
			                ...
			                <div class="ibox-content" style="width:50%;margin:0 auto;">
			                    <form id="inputForm" action="update.ct" method="post" class="form-horizontal m-t">
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-sm-8">
		                                	<input type="radio" [#if member.isEnabled]checked="checked"[/#if] class="checkbox checkbox-inline" id="isEnabled" name="isEnabled" value="true" checked="checked">${message("console.common.true")}
