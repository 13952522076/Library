...
<title>${message("console.dictStudent.add")} - 小书僮™智慧幼教管理平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("console.dictStudent.add")}</h2>
                    <ol class="breadcrumb">
                        <li>
	                                     ...
	                                     <table class="table table-striped">
											...
											<tr>
												...
												<td style="text-align: left;">
													<input type="text" name="stuDate" id="stuDate" class="laydate-icon form-control layer-date" maxlength="50" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<div style="float: left;">
													     <label class="radio-inline">
							                                <input type="radio" class="checkbox checkbox-inline" id="studentStatus" name="studentStatus" value="active" checked="checked">
							                                ${message("DictStudent.studentStatus.active")}
							                             </label>
							                             <label class="radio-inline">
							                                <input type="radio" class="checkbox checkbox-inline" id="studentStatus" name="studentStatus" value="graduated">
							                                ${message("DictStudent.studentStatus.graduated")}
							                             </label>
							                             <label class="radio-inline">
							                                <input type="radio" class="checkbox checkbox-inline" id="studentStatus" name="studentStatus" value="quit">
							                                ${message("DictStudent.studentStatus.quit")}
							                             </label>
							                             <label class="radio-inline">
							                                <input type="radio" class="checkbox checkbox-inline" id="studentStatus" name="studentStatus" value="dropouts">
											...
											<tr>
												...
												<td style="text-align: left;">
													<input type="text" name="birthday" id="birthday"   class="laydate-icon form-control layer-date" maxlength="50" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="stuAddress" class="form-control" maxlength="20" />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="stuRmark" class="form-control" maxlength="20" />
												</td>
											</tr>
											<tr>
												<th>
