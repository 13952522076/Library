...
<head>
    ...
    <title>${message("编辑系统字典")} - 小书僮™智慧幼教管理平台</title>
            ...
            $inputForm.validate({
                rules: {
                    code: {
                        ...
                        maxlength: 15,
                        remote: {
							url: "checkCodeExsit_edit.ct?preCode=${systemDict.code}",
							cache: false
						}
                    },
                    codeDesc: {
                        ...
                        maxlength: 20,
                        remote: {
							url: "checkCodeDescExsit_edit.ct?preCodeDesc=${systemDict.codeDesc}",
							cache: false
						}
                    }
                },
                                ...
                                <div class="ibox-content" style="width:50%;margin:0 auto;">
                                    ...
                                    <div class="table-responsive">
                                        <table id="listTable" class="table table-striped">
                                            <tr>
                                                <th>
                                                	<span class="requiredField">*</span>${message("代码")}:
                                            	</th>
                                                <td><input type="text" name="code" class="form-control" value="${systemDict.code}" maxlength="30" /></td>
                                            </tr>
                                            <tr>
                                                <th>
                                                    <span class="requiredField">*</span>${message("代码描述")}:
                                                </th>
                                                <td><input type="text" name="codeDesc" class="form-control" value="${systemDict.codeDesc}" maxlength="30" /></td>
                                            </tr>
                                        </table>
                                        <table class="input">
                                            <tr>
