...
<head>
    ...
    <title>${message("添加系统字典")} - 小书僮™智慧幼教管理平台</title>
                                    ...
                                    <div class="table-responsive">
                                        <table id="listTable" class="table table-striped">
                                            <tr>
                                                ...
                                                <td><input type="text" name="code" class="form-control" maxlength="30" /></td>
                                            </tr>
                                            <tr>
                                                <th>
                                                    <span class="requiredField">*</span>${message("代码描述")}:
                                                </th>
                                                <td><input type="text" name="codeDesc" class="form-control" maxlength="30" /></td>
                                            </tr>
                                        </table>
                                        <table class="input">
                                            <tr>
