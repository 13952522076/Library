...
<title>${message("console.appCategory.add")} - 小书僮™智慧幼教管理平台</title>
   ...
   <div id="wrapper">
	    ...
	    <div id="page-wrapper" class="gray-bg dashbard-1">
	        ...
	        <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<h2> ${message("console.appCategory.add")} </h2>
	                <ol class="breadcrumb">
						<li>
						    <!--首页-->
	                    ...
	                    <li>
	                        <strong>${message("console.appCategory.add")}</strong>
	                    </li>
					</ol>
	            </div>
	            <div class="col-lg-2">
			                            ...
			                            <div class="col-sm-8">
			                                <div class="itemList-upload" style="float:left;">
												<div class="imgShowBox">
													...
													<!--<a href="javascript:;" title="删除图片" class="delImg" id="delLogoAppCategoryImg">×</a>-->
												</div>
												<div class="uploadContainer" style="margin-left: 7px;">
													<input type="file" id="logoAppCategoryImgUpload" />
													<input type="hidden" id="logoAppCategoryImg" name="appCategoryLogoUrl" value="">
												</div>
											</div>
