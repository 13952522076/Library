...
<title>${message("编辑年级")} - 小书僮™智慧幼教管理平台</title>
	...
	$inputForm.validate({
		rules: {
			gradeName: {
				...
				maxlength:10,
				remote: {
					url: "checkNameExsit.ct?preName=${dictGrade.gradeName}",
					cache: false
				}
			}
		},
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
	             ...
	             <form id="inputForm" action="update.ct" method="post">
	             	<input type="hidden" value="${dictGrade.id}" name="id">
		             <div class="row">
	                    <div class="col-lg-12">
	                            ...
	                            <div class="ibox-content" style="width:50% ;margin:0 auto;">
	                                <div class="table-responsive">
	                                     <table id="listTable" class="table table-striped">
											<tr>
												<th>
													<span class="requiredField">*</span>${message("年级名称")}:
												</th>
												<td>
													<input type="text" name="gradeName" value="${dictGrade.gradeName}" class="form-control"  />
												</td>
											</tr>
										</table>
										<table class="input">
