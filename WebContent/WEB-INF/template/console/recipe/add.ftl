...
<title>${message("console.recipe.add")} - 小书僮™智慧幼教管理平台</title>
							                                    ...
							                                    <div id="mondayTab" class="tab-pane active">
							                                        <table class="table table-striped">
																		<tr>
																			...
																			<td>
																			    <div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[0].recipeSections[0].description"></textarea>
																				</div>
																			</td>
																			<td>
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[0].recipeSections[1].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[0].recipeSections[2].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
							                                    ...
							                                    <div id="tuesdayTab" class="tab-pane">
							                                        <table class="table table-striped">
																		<tr>
																			...
																			<td>
																			    <div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[1].recipeSections[0].description" ></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[1].recipeSections[1].description" ></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[1].recipeSections[2].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
							                                    ...
							                                    <div id="wednesdayTab" class="tab-pane">
							                                         <table class="table table-striped">
																		<tr>
																			...
																			<td>
																			    <div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[2].recipeSections[0].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[2].recipeSections[1].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[2].recipeSections[2].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
							                                     ...
							                                     <div id="thursdayTab" class="tab-pane">
							                                         <table class="table table-striped">
																		<tr>
																			...
																			<td>
																			    <div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[3].recipeSections[0].description" ></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[3].recipeSections[1].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[3].recipeSections[2].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
							                                     ...
							                                     <div id="fridayTab" class="tab-pane">
							                                         <table class="table table-striped">
																		<tr>
																			...
																			<td>
																			    <div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[4].recipeSections[0].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[4].recipeSections[1].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
																		...
																		<tr>
																			...
																			<td>
																				<div class="left">
																					<textarea class="textAreaMain J_input J_swfDisc" name="recipeWeekDays[4].recipeSections[2].description"></textarea>
																				</div>
																			</td>
																			<td>
																			    <div class="left addicon J_swf J_uploadflash" style="position: relative; left: 0px;">
