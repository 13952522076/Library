...
<title>${message("shop.member.deposit.recharge")}[#if systemShowPowered] - 小书僮™智慧幼教管理平台[/#if]</title>
	...
	<div class="container member">
		...
		<div class="span18 last">
			<div class="input deposit">
				...
				<form id="inputForm" action="${base}/payment/submit.ct" method="post" target="_blank">
					...
					<table class="input">
						...
						<tr>
							...
							<td>
								...
								<input type="button" class="button" value="${message("shop.member.back")}" onclick="location.href='list.ct'" />
							</td>
						</tr>
					</table>
				</form>
