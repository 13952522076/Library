...
<title>${message("shop.order.payment")}[#if systemShowPowered] - 小书僮™智慧幼教管理平台[/#if]</title>
...
<body>
	...
	<div class="container order">
		<div id="dialog" class="dialog">
			...
			<div>
				<a href="view.ct?sn=${order.sn}">${message("shop.order.paid")}</a>
		...
		<div class="span24">
			...
			<div class="result">
				...
				<table>
					...
					<tr>
						...
						<td width="340">
							...
							<a href="view.ct?sn=${order.sn}">[${message("shop.order.view")}]</a>
						</td>
				...
				[#if order.paymentStatus != "paid"]
					[#if order.paymentMethod.method == "online"]
						[#if paymentPlugins??]
							<form id="paymentForm" action="${base}/payment/submit.ct" method="post" target="_blank">
