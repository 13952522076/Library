...
<title>${message("shop.member.receiver.list")}[#if systemShowPowered] - 小书僮™智慧幼教管理平台[/#if]</title>
	...
	<div class="container member">
		...
		<div class="span18 last">
			<div class="list">
				...
				<div class="bar">
					<a href="add.ct" class="button">${message("shop.member.receiver.add")}</a>
				</div>
				<table id="listTable" class="list">
					...
					[#list page.content as receiver]
						<tr[#if !receiver_has_next] class="last"[/#if]>
							...
							<td>
								<a href="edit.ct?id=${receiver.id}">[${message("shop.member.handle.edit")}]</a>
