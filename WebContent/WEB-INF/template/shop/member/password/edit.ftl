...
<title>${message("shop.member.password.edit")}[#if systemShowPowered] - 小书僮™智慧幼教管理平台[/#if]</title>
					...
					<table class="input">
						...
						<tr>
							...
							<td>
								...
								<input type="button" class="button" value="${message("shop.member.back")}" onclick="location.href='../index.ct'" />
							</td>
						</tr>
					</table>
				</form>
