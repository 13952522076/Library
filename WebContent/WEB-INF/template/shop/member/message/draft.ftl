...
<title>${message("shop.member.message.draft")}[#if systemShowPowered] - 小书僮™智慧幼教管理平台[/#if]</title>
				...
				<table id="listTable" class="list">
					...
					[#list page.content as memberMessage]
						<tr[#if !memberMessage_has_next] class="last"[/#if]>
							...
							<td>
								<a href="send.ct?draftMessageId=${memberMessage.id}">[${message("shop.member.handle.view")}]</a>
