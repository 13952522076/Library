...
public class Point extends BaseEntity
{
     ...
     * 注释内容
     */
    private static final long serialVersionUID = 2567218359560806483L;
    ...
    public Point(BigDecimal id, Long bizId, Date createAt, Date expireAt, String memo, String owner, Long status,
            Long type, BigDecimal userId, Long valueP)
    {
        this.id = id;
        this.bizId = bizId;
        this.createAt = createAt;
