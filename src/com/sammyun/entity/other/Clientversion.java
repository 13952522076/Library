...
public class Clientversion extends BaseEntity
{
     ...
     * 注释内容
     */
    private static final long serialVersionUID = -8257375354169976438L;
    ...
    public Clientversion(BigDecimal id, BigDecimal timeCreate, String description, String urlDownload, String fileSize,
            BigDecimal timeModify, Long typeOs, Long flagPublish, BigDecimal timePublish, Long typeUpgrade,
            String versionName, String versionNumber, BigDecimal idCreator, BigDecimal idModifier,
