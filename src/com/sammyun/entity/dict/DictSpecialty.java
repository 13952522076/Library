...
public class DictSpecialty extends BaseEntity
{
     ...
     * 注释内容
     */
    private static final long serialVersionUID = -6851076780801864552L;
    ...
    public DictSpecialty(BigDecimal id, String code, String description, String name, String codeStd, BigDecimal idDept)
    {
        this.id = id;
        this.code = code;
