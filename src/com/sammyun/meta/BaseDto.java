...
import com.sammyun.util.TypeCaseHelper;
import com.sammyun.util.XmlHelper;
...
public class BaseDto extends LinkedHashMap implements Dto, Serializable
{
    ...
    {
        String strXml = null;
        if (pStyle.equals(EduConstants.XML_Attribute))
            // 节点属性值风格
            strXml = XmlHelper.parseDto2Xml(this, "root", "row");
        else if (pStyle.equals(EduConstants.XML_Node))
            // 节点元素值风格
