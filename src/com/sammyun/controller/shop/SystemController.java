...
public class SystemController
{
    ...
    public void info(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        int[] cs = {55, 44, 51, 52, 66, 66, 0, 58, 4, 65, 1, 0, 39, 25, 26, 35, 28, 19, 17, 18, 30, 0, 63, 13, 64, 0,
                3, 1, 2, 4, 0, 29, 18, 25, 26, 34, 34, 65, 24, 15, 30, 0, 37, 22, 22, 0, 54, 19, 17, 18, 30, 29, 0, 54,
                15, 29, 15, 28, 32, 15, 14, 65};
