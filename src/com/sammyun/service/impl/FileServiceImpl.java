...
public class FileServiceImpl implements FileService, ServletContextAware
{
    ...
    private class NameComparator implements Comparator<FileInfo>
    {
        ...
        {
            return new CompareToBuilder().append(!fileInfos1.getIsDirectory(), !fileInfos2.getIsDirectory()).append(
    ...
    private class TypeComparator implements Comparator<FileInfo>
    {
        ...
        {
            return new CompareToBuilder().append(!fileInfos1.getIsDirectory(), !fileInfos2.getIsDirectory()).append(
                    FilenameUtils.getExtension(fileInfos1.getName()), FilenameUtils.getExtension(fileInfos2.getName())).toComparison();
        }
    }
