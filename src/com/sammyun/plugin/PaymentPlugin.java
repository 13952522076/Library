...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin>
{
    ...
    protected String getNotifyUrl(String sn, NotifyMethod notifyMethod)
    {
        ...
        {
            return setting.getSiteUrl() + "/payment/notify/" + NotifyMethod.general + "/" + sn + ".ct";
        }
        return setting.getSiteUrl() + "/payment/notify/" + notifyMethod + "/" + sn + ".ct";
    }
    ...
    protected String getMobileNotifyUrl(String sn, NotifyMethod notifyMethod)
    {
        ...
        if (notifyMethod == null)
        {
            return setting.getSiteUrl() + "/payment/mobileNotify/" + NotifyMethod.general + "/" + sn + ".ct";
        }
        return setting.getSiteUrl() + "/payment/mobileNotify/" + notifyMethod + "/" + sn + ".ct";
    }
    ...
    {
        return new CompareToBuilder().append(getOrder(), paymentPlugin.getOrder()).append(getId(),
                paymentPlugin.getId()).toComparison();
    }
