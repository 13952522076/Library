...
<title>${message("console.plugin.paypal.setting")} -图书智能管理推荐系统</title>
                            ...
                            <div class="row">
                       		 ...
                       		 <div class="table-responsive">
	                             <table class="table table-striped">
									...
									<tr>
										<th>
											<span class="requiredField">*</span>${message("console.plugin.paypal.partner")}:
										</th>
										<td>
									...
									<tr>
										<th>
											${message("console.plugin.paypal.currency")}:
										</th>
										<td>
