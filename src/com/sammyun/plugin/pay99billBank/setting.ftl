...
<title>${message("console.plugin.pay99billBank.setting")} -图书智能管理推荐系统</title>
...
<div id="wrapper">
	   ...
	   <div class="row wrapper border-bottom white-bg page-heading">
	        <div class="col-lg-10">
                    <h2> ${message("console.plugin.paypal.setting")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong> ${message("console.plugin.paypal.setting")}</strong>
                        </li>
                    </ol>
                </div>
	         <div class="col-lg-2">
	                    ...
	                    <div class="row">
	               		 ...
	               		 <div class="table-responsive">
	                         <table class="table table-striped">
									...
									<tr>
										<th>
											<span class="requiredField">*</span>${message("console.plugin.pay99billBank.partner")}:
										</th>
										<td>
									...
									<tr>
										<th>
											<span class="requiredField">*</span>${message("console.plugin.pay99billBank.key")}:
										</th>
										<td>
