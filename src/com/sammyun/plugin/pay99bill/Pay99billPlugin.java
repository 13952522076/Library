 ...
 */
package com.sammyun.plugin.pay99bill;
...
public class Pay99billPlugin extends PaymentPlugin
{
    ...
    {
        return "pay_99bill/install.ct";
    }

    @Override
    public String getUninstallUrl()
    {
        return "pay_99bill/uninstall.ct";
    }

    @Override
    public String getSettingUrl()
    {
        return "pay_99bill/setting.ct";
    }
    ...
    public boolean verifyNotify(String sn, NotifyMethod notifyMethod, HttpServletRequest request)
    {
        ...
        if (generateSign(parameterMap).equals(request.getParameter("signMsg"))
                ...
                && payment.getAmount().multiply(new BigDecimal(100)).compareTo(
                        new BigDecimal(request.getParameter("payAmount"))) == 0)
        {
            return true;
        }
        return false;
