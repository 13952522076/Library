...
public class AlipayPartnerPlugin extends PaymentPlugin
{
    ...
    {
        return "alipay_partner/install.ct";
    }

    @Override
    public String getUninstallUrl()
    {
        return "alipay_partner/uninstall.ct";
    }

    @Override
    public String getSettingUrl()
    {
        return "alipay_partner/setting.ct";
    }
...
*/
    ...
    public boolean verifyNotify(String sn, NotifyMethod notifyMethod, HttpServletRequest request)
    {
        ...
        if (generateSign(request.getParameterMap()).equals(request.getParameter("sign"))
                ...
                && ("WAIT_SELLER_SEND_GOODS".equals(request.getParameter("trade_status")) || "TRADE_FINISHED".equals(request.getParameter("trade_status")))
