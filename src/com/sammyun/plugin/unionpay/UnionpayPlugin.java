 ...
 */
package com.sammyun.plugin.unionpay;
...
public class UnionpayPlugin extends PaymentPlugin
{
    ...
    {
        return "unionpay/install.ct";
    }

    @Override
    public String getUninstallUrl()
    {
        return "unionpay/uninstall.ct";
    }

    @Override
    public String getSettingUrl()
    {
        return "unionpay/setting.ct";
    }
    ...
    public boolean verifyNotify(String sn, NotifyMethod notifyMethod, HttpServletRequest request)
    {
        ...
        if (generateSign(request.getParameterMap()).equals(request.getParameter("signature"))
                ...
                && payment.getAmount().multiply(new BigDecimal(100)).compareTo(
                        new BigDecimal(request.getParameter("orderAmount"))) == 0)
        {
            Map<String, Object> parameterMap = new HashMap<String, Object>();
            parameterMap.put("version", "1.0.0");
            parameterMap.put("charset", "UTF-8");
